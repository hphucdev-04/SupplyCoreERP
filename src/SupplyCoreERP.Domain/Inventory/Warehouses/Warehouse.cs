...
public class Warehouse : FullAuditedAggregateRoot<Guid>
{
    ...
    public void SentToApprove()
    {
        if (Status != ApprovalStatus.Draft)
        {
            throw new BusinessException("SupplyCoreERP:InvalidWarehouse", "Chỉ phiếu ở trạng thái Nháp mới có thể được gửi phê duyệt.");
        }
    ...
    public void Approve()
    {
        ...
        {
            throw new BusinessException("SupplyCoreERP:InvalidWarehouse", "Chỉ phiếu chờ duyệt mới có thể được duyệt.");
        }
    ...
    public void Reject()
    {
        if (Status != ApprovalStatus.Pending)
        {
            throw new BusinessException("SupplyCoreERP:InvalidWarehouse", "Chỉ phiếu chờ duyệt mới có thể bị từ chối.");
        }
