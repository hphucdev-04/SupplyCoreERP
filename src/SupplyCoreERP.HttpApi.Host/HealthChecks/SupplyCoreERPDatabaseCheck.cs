...
namespace SupplyCoreERP.HealthChecks;

public class SupplyCoreERPDatabaseCheck : IHealthCheck, ITransientDependency
{
    protected readonly IIdentityRoleRepository IdentityRoleRepository;

    public SupplyCoreERPDatabaseCheck(IIdentityRoleRepository identityRoleRepository)
    {
