...
namespace SupplyCoreERP.Migrations
{
    ...
    [Migration("20260516043244_Add-InventoryAdjustment")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("SupplyCoreERP.ActiveIngredients.ActiveIngredient", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("SupplyCoreERP.BaseUnits.BaseUnit", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("SupplyCoreERP.Categories.Category", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("SupplyCoreERP.Customers.Customer", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("SupplyCoreERP.DocumentSequences.DocumentSequence", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("SupplyCoreERP.Inventories.Adjustments.InventoryAdjustment", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
                    ...
                    b.ToTable("AppInventoryAdjustments", (string)null);
                });

            modelBuilder.Entity("SupplyCoreERP.Inventories.Adjustments.InventoryAdjustmentLine", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
                    ...
                    b.ToTable("AppInventoryAdjustmentLines", (string)null);
                });

            modelBuilder.Entity("SupplyCoreERP.Inventories.Balances.InventoryBalance", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("SupplyCoreERP.Inventories.Tickets.InventoryTicketDetail", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("SupplyCoreERP.Inventories.Tickets.InventoryTicketLine", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");

                    b.Property<Guid?>("AdjustmentLineId")
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("SupplyCoreERP.Manufacturers.Manufacturer", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("SupplyCoreERP.Medicines.MedicineIngredient", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("SupplyCoreERP.Notifications.UserNotification", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("SupplyCoreERP.Orders.PO.PurchaseOrderLine", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("SupplyCoreERP.Products.Product", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("SupplyCoreERP.Products.ProductUnit", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("SupplyCoreERP.Warehouses.Zone", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("SupplyCoreERP.Medicines.Medicine", b =>
                {
                    b.HasBaseType("SupplyCoreERP.Products.Product");
            ...
            modelBuilder.Entity("SupplyCoreERP.Inventories.Adjustments.InventoryAdjustmentLine", b =>
                {
                    b.HasOne("SupplyCoreERP.Inventories.Adjustments.InventoryAdjustment", "Adjustment")
                        .WithMany("Lines")
            ...
            modelBuilder.Entity("SupplyCoreERP.Inventories.Tickets.InventoryTicketDetail", b =>
                {
                    ...
                    b.HasOne("SupplyCoreERP.Inventories.Tickets.InventoryTicketLine", "TicketLine")
                        .WithMany("Details")
            ...
            modelBuilder.Entity("SupplyCoreERP.Inventories.Tickets.InventoryTicketLine", b =>
                {
                    b.HasOne("SupplyCoreERP.Inventories.Adjustments.InventoryAdjustmentLine", "AdjustmentLine")
                        .WithMany()
                        .HasForeignKey("AdjustmentLineId");
                    ...
                    b.HasOne("SupplyCoreERP.Orders.PO.PurchaseOrderLine", "PurchaseOrderLine")
                        .WithMany()
                        .HasForeignKey("PurchaseOrderLineId")
                        .OnDelete(DeleteBehavior.Restrict);

                    b.HasOne("SupplyCoreERP.Sales.Orders.SalesOrderLine", "SalesOrderLine")
                        .WithMany()
            ...
            modelBuilder.Entity("SupplyCoreERP.Medicines.MedicineIngredient", b =>
                {
                    b.HasOne("SupplyCoreERP.ActiveIngredients.ActiveIngredient", "ActiveIngredient")
                        .WithMany()
            ...
            modelBuilder.Entity("SupplyCoreERP.Orders.PO.PurchaseOrderLine", b =>
                {
                    ...
                    b.HasOne("SupplyCoreERP.Orders.PO.PurchaseOrder", "PurchaseOrder")
                        .WithMany("Lines")
            ...
            modelBuilder.Entity("SupplyCoreERP.Products.Product", b =>
                {
                    b.HasOne("SupplyCoreERP.BaseUnits.BaseUnit", "BaseUnit")
                        .WithMany()
                        .HasForeignKey("BaseUnitId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("SupplyCoreERP.Categories.Category", "Category")
                        .WithMany("Products")
                        .HasForeignKey("CategoryId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("SupplyCoreERP.Manufacturers.Manufacturer", "Manufacturer")
                        .WithMany()
            ...
            modelBuilder.Entity("SupplyCoreERP.Sales.Orders.SalesOrder", b =>
                {
                    b.HasOne("SupplyCoreERP.Customers.Customer", "Customer")
                        .WithMany()
            ...
            modelBuilder.Entity("SupplyCoreERP.Suppliers.SupplierProduct", b =>
                {
                    b.HasOne("SupplyCoreERP.BaseUnits.BaseUnit", "DefaultUnit")
                        .WithMany()
            ...
            modelBuilder.Entity("SupplyCoreERP.Warehouses.Bin", b =>
                {
                    ...
                    b.HasOne("SupplyCoreERP.Warehouses.Zone", "Zone")
                        .WithMany()
            ...
            modelBuilder.Entity("SupplyCoreERP.Medicines.Medicine", b =>
                {
                    b.HasOne("SupplyCoreERP.DosageForms.DosageForm", "DosageForm")
                        .WithMany()
                        .HasForeignKey("DosageFormId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("SupplyCoreERP.Products.Product", null)
                        .WithOne()
                        .HasForeignKey("SupplyCoreERP.Medicines.Medicine", "Id")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
