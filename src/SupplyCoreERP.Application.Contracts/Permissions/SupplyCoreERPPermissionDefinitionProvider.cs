...
public class SupplyCoreERPPermissionDefinitionProvider : PermissionDefinitionProvider
{
    public override void Define(IPermissionDefinitionContext context)
    {
        ...
        // Parent Group
        PermissionGroupDefinition catalogGroup = context.AddGroup(SupplyCoreERPPermissions.Catalog.GroupNameCatalog, L("Permission:Catalog"));
        ...
        //Medicine 
        PermissionDefinition medicinePermision = AddCrudPermissions(catalogGroup, SupplyCoreERPPermissions.Catalog.Medicine.Default, "Medicine");
        // Add Child
        ...
        // Parent Group
        PermissionGroupDefinition partnerGroup = context.AddGroup(SupplyCoreERPPermissions.Partner.GroupNamePartner, L("Permission:Partner"));
        ...
        // Parent Group
        PermissionGroupDefinition inventoryGroup = context.AddGroup(SupplyCoreERPPermissions.Inventory.GroupNameInventory, L("Permission:Inventory"));

        // Warehouse
        PermissionDefinition warehousePermission = AddCrudPermissions(inventoryGroup, SupplyCoreERPPermissions.Inventory.Warehouse.Default, "Warehouse");
        // Add Child
        ...
        // Ticket
        PermissionDefinition ticketPermission = AddCrudPermissions(inventoryGroup, SupplyCoreERPPermissions.Inventory.Ticket.Default, "Ticket");
        // Add Child
        ...
        // Parent Group
        PermissionGroupDefinition orderGroup = context.AddGroup(SupplyCoreERPPermissions.Order.GroupNameOrder, L("Permission:Order"));

        // PurchaseOrder
        PermissionDefinition purchaseOrderPermission = AddCrudPermissions(orderGroup, SupplyCoreERPPermissions.Order.PurchaseOrder.Default, "PurchaseOrder");
        // Add Child
    ...
    {
        // Default (View) 
        PermissionDefinition parentPermission = group.AddPermission(
            permissionName,
