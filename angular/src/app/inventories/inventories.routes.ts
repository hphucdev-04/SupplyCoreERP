...
export const INVENTORIES_ROUTES: Routes = [
  ...
  },
  {
    ...
    loadComponent: () =>
      import('./warehouses/storage-locations/storage-locations.component').then(
        m => m.StorageLocationsComponent,
      ),
  },
  {
    path: 'tickets',
  ...
  },
  {
    ...
    loadComponent: () =>
      import('./tickets/tickets-details/ticket-details.component').then(
...

  {
    ...
    loadComponent: () =>
      import('./batches/batch-details/batch-details.component').then(m => m.BatchDetailsComponent),
  },
  {
    path: 'balances',
