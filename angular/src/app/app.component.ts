...
@Component({
  ...
  template: `
    ...
    <div id="notification" style="position: fixed; top: 0.1rem; right: 7rem; z-index: 1020; display: flex; gap: 10px; align-items: center;">
      <button class="btn-ask-ai" (click)="isChatOpen = true" style="display: flex; align-items: center; gap: 8px; padding: 4px 10px; background: linear-gradient(135deg, #0ea5e9 0%, #2563eb 100%); color: white; border: none; border-radius: 6px; font-size: 12px; font-weight: 600; cursor: pointer; box-shadow: 0 2px 8px rgba(37, 99, 235, 0.2); transition: all 0.2s;">
