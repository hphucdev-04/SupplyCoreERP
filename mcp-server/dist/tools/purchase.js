...
export const registerPurchaseTools = (server) => {
    server.registerTool("get_inbound_pipeline", {
    ...
    server.registerTool("get_requisition_backlog", {
    ...
    server.registerTool("get_supplier_supply_options", {
